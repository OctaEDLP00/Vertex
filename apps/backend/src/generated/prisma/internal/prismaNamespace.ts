 ...
 * SelectSubset
 *
 * From `T` pick properties that exist in `U`. Simple version of Intersection. Additionally, it
 * validates, if both select and include are present. If the case, it errors.
 */
    ...
    PersonalAccessToken: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.PersonalAccessTokenCountAggregateOutputType>
            | number
        }
      }
    }
...
export type PersonalAccessTokenScalarFieldEnum =
  (typeof PersonalAccessTokenScalarFieldEnum)[keyof typeof PersonalAccessTokenScalarFieldEnum]
...
export type PullRequestScalarFieldEnum =
  (typeof PullRequestScalarFieldEnum)[keyof typeof PullRequestScalarFieldEnum]
...
export type PrismaClientOptions = (
  ...
  | {
      /**
       * Prisma Accelerate URL allowing the client to connect through Accelerate instead of a direct
       * database.
       */
  ...
  /**
   * SQL commenter plugins that add metadata to SQL queries as comments. Comments follow the
  ...
  /**
   * Optional maximum size for the query plan cache. If not provided, a default size will be used. A
   * value of `0` can be used to disable the cache entirely. A higher cache size can improve
